...
export const calloutData = {
  ...
  focusJob: {
    ...
    text: 'a Senior Product Manager at CHECK24 Flug in Berlin, where I focus on payment topics.',
...
export const experienceData: Experience[] = [
  {
    ...
    roles: [
      {
        title: 'Senior Product Manager Payment | Backend',
        range: 'April 2025 - ...',
        text: [
          'Driving the product strategy and development for payment and backend systems.',
          'Leading cross-functional teams to deliver high-impact payment features and architectural improvements.',
          'Mentoring junior product managers and optimizing product operations and processes.'
        ],
        skills: [
          'Product Management',
          'Product Strategy',
      ...
      {
        title: 'Product Manager Payment | Backend',
        range: 'March 2024 - April 2025',
        text: [
  ...
  },
  {
    ...
    roles: [
      {
        title: 'Trainee Innovation Manager',
  ...
  },
  {
    ...
    location: 'Berlin, Germany',
    url: '',
    desc: 'Heyer Digital Innovation helps companies to successfully master digital transformation.',
    roles: [
      {
        title: 'Innovation Assistant',
        range: 'January 2019 - April 2019',
        text: [
          'Supported customer research and research & intelligence for client projects.',
          'Assisted the manager with administrative tasks and operational support.'
        ],
        skills: ['Innovation Management', 'Research', 'Office Operations']
      }
    ]
  }
];
