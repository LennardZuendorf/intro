...
title: Ignitus
date: 06/12/2023
description: This website, portfolio page for my projects and showcases.
images: ["/projects/habitus-thumbnail.png", "/projects/habitus-thumbnail.png"]
focus: False
active: True
...
<Callout>
  - project for the previous version of this website (ignitus = close enough to
  latin for ignite) - build on top of
  [tailwind-nextjs-starter-blog](https://github.com/timlrx/tailwind-nextjs-starter-blog/tree/master)
...
My last name is Zündorf, which is a city/village near Cologne. But "Zünd" or "zünden" also basically can be translated to ignite. Add something in the area of "I like to ignite ideas" and you got ignitr. Plus you can think of blue or yellow flames which you'll find in the gradient accents of this website.ill move it to a multi-module project and also include quarkus plus potentially some caching with redis or other technology.
