...
images: ["/projects/twinkles-thumbnail.png"]
focus: False
active: True
...
<Callout>
  - It's an idea for real **location-based, real-time dating**. - Build in
  Flutter and on Firebase, with the help of
  [Flutterflow](https://flutterflow.io). - Never completed, but a great showcase
  for the power of low-code and Flutter.
</Callout>
