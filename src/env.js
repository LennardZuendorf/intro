...
export const env = createEnv({
  server: {
    ...
    PAYLOAD_USE_PG_URL: z.string().optional(),
    PAYLOAD_USE_VERCEL_BLOB: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    PAYLOAD_USE_PG_URL: process.env.PAYLOAD_USE_PG_URL,
    PAYLOAD_USE_VERCEL_BLOB: process.env.PAYLOAD_USE_VERCEL_BLOB,
