...
export const socials: readonly Social[] = [
  ...
  },
  {
    _id: 'x',
    _title: 'X',
    url: 'https://x.com/lennardzuendorf',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622Zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77Z"/></svg>'
  },
  {
    _id: 'bluesky',
    _title: 'Bluesky',
    url: 'https://bsky.app/profile/lennardzuendorf.bsky.social',
  ...
  },
  {
    _id: 'email',
    _title: 'Email',
    url: 'mailto:l.p.zuendorf@gmail.com',
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M1.5 4.5a3 3 0 0 1 3-3h15a3 3 0 0 1 3 3v15a3 3 0 0 1-3 3h-15a3 3 0 0 1-3-3v-15Zm3-1.5a1.5 1.5 0 0 0-1.5 1.5v.677l9 5.25 9-5.25V4.5A1.5 1.5 0 0 0 19.5 3h-15ZM21 7.152l-9 5.25-9-5.25V19.5A1.5 1.5 0 0 0 4.5 21h15a1.5 1.5 0 0 0 1.5-1.5V7.152Z"/></svg>'
  }
] as const;
