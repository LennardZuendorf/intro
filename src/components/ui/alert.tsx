...
const alertVariants = cva(
  cn(
    "group/alert relative grid w-full grid-cols-[0_1fr] items-start gap-y-1 rounded-base border-4 border-border px-4 py-3 text-left text-sm shadow-md shadow-shadow",
