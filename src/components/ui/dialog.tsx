...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn('text-sm font-base text-primary-foreground', className)}
    {...props}
  />
));
