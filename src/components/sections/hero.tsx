...
import { fetchExperienceById } from '@/lib/content/fetchExperiences';
import { fetchProjectById } from '@/lib/content/fetchProjects';
...
export const HeroSection = async ({ className, siteControls }: HeroSectionProps) => {
  // Fetch all hero data with fallbacks handled centrally
            ...
            <Card id='hero-card' className='relative w-full' interactive='slight' rotation='slight'>
              ...
              <CardContent className='gap-4 p-5 pt-0 md:p-6 md:pt-0 2xl:p-8 2xl:pt-0'>
                <div className='grid grid-cols-1 items-center justify-center gap-2 mb-3 md:grid-cols-3'>
                  <div className='md:col-span-2'>
                    ...
                    typeof sectionContent.MainIntroSection === 'object' &&
                    'root' in sectionContent.MainIntroSection ? (
                      <RichText
              ...
              <CardFooter className='pl-5'>
                ...
                <div id='hero-social-buttons' className='mt-1'>
                  <SocialButtons socials={socialTags} iconSize='1.25rem' buttonVariant='default' />
                </div>
              </CardFooter>
            </Card>
            ...
            {siteControls.sectionVisibility?.showAbout && (
              ...
              >
                <CardHeader className='p-5 pb-2 md:p-6 md:pb-2 2xl:p-8 2xl:pb-2'>
                  ...
                  <H3 className='rotate-1'>{experience?.position}</H3>
                </CardHeader>
                <CardContent className='p-5 pt-0 md:p-6 md:pt-0 2xl:p-8 2xl:pt-0'>
                  <div id='current-role-content' className='max-w-none mb-3'>
                    <M className='font-mono leading-relaxed'>{experience?.description}</M>
                  </div>
